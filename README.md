...
The goal is to generate actionable business insights that can improve operational efficiency and reduce delivery delays.
...
The data was imported into MySQL and tables were renamed to simplified schema names (shipments, routes, delivery_agents, warehouses, orders) for better readability and query clarity.
...
- Warehouse utilization percentage calculation
